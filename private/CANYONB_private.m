function out=CANYONB_private(gtime,lat,lon,pres,temp,psal,doxy,param,epres,etemp,epsal,edoxy)
...
% T, S and O2 data using Bayesian neural networks. Front. Mar. Sci. 5:328.
...
if i==4, outderiv=derivnum('par2',2300,out.(paramnames{i})(:),1,2,35,25,NaN,0,NaN,0,0,1,10,1); 
    out.inx.(paramnames{i})=repmat(outderiv(:,2),1,4).*out.inx.(paramnames{i}); clear outderiv
end
clear inx inval ddp
